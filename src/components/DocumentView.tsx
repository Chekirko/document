...
import { ArrowLeft, Calendar, Tag, Brain, Clock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <button
          onClick={() => router.back()}
          className="flex mb-8 items-center text-gray-600 hover:text-gray-900 mr-4"
        >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {!showAnalysis && (
                  <button
                    ...
                    disabled={isPending}
                    className="px-4 py-2 bg-black text-white rounded-lg hover:bg-[linear-gradient(68.94deg,#c3aab2_-4.77%,#9ec_46.72%,#80c0c8_90.23%,#4b8bfa_134.46%)] disabled:opacity-50 flex items-center space-x-2 transition-colors"
                  >
                    {isPending ? (
                      <>
