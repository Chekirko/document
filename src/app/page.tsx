...
// import { Search, FileText, Bot, Calendar, Filter } from "lucide-react";
...
//   // Завантажуємо початкові документи
//   // useEffect(() => {
//   //   fetchDocuments();
//   // }, []);
...
//     if (documentType) {
//       activeFilters.document_type = documentType;
//     }
//     if (selectedCategory) {
//       activeFilters.category = selectedCategory;
//     }

//     // Викликаємо завантаження документів з поточними фільтрами
//     // щоразу при зміні documentType або selectedCategory
